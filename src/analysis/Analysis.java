...
public class Analysis {
    public static String store_base_path;

    // One abstract class may be implemented by multiple classes.
    public static Map<SootClass, Set<SootClass>> interfaceClassToImplementedClasses = new HashMap<>();
    public static Map<SootClass, Set<SootClass>> interfaceClassToSubInterfaceClasses = new HashMap<>();

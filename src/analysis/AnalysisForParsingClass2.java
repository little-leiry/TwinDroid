...
public class AnalysisForParsingClass2 extends Analysis {
    ...
    public static final String parsingPackageClass = "android.content.pm.parsing.ParsingPackageUtils";
    // The class for store the parsed package's settings.
    public static final String parsedPackageSettingsClass = "android.content.pm.parsing.ParsingPackageImpl";
    ...
    public static boolean isTargetPackageSetting(String ds){
        if(ds!=null && ds.contains("<") && ds.contains(parsedPackageSettingsClass)) {
    ...
    public static void findEntryBaseUnits() {
        List<SootMethod> methods = Utils.getMethodsOfClass(parsingPackageClass);
    ...
    public static void findTargetPackageSettings(){
        ...
        for(Map.Entry<String, Set<String>> entry: associatedElementTypeToDataStructures.entrySet()){
            ...
            Log.logData(element_data, "+ Associated element type: " + associated_element_type);

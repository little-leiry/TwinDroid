...
public class AnalysisForSystemClass2 extends Analysis{
    ...
    public static final String suspicious_methods_final = store_base_path + "logs/processing/suspicious_methods_deduplicate.txt";
    public static final String processing_method_structInfo = store_base_path + "logs/processing/processing_methods_structs.txt";
    ...
    public static Map<String, String> getEntryBridges(){
        ...
        String className = AnalysisForParsingClass2.parsedPackage_settings_class; // The class for storing the parsed package's settings.
    ...
    public static void identifySuspiciousMethods(){
        ...
        Log.deleteData(processing_method_structInfo);
        ...
        for(Map.Entry<SootMethod, Map<String, Set<String>>> m_e_d_entry : methodToAETToDSs.entrySet()){
            ...
            Log.logData(processing_method_structInfo, Utils.generatePartingLine("#"));
            Log.logData(processing_method_structInfo, "+ Method: " + method_sig);
            for(Map.Entry<String, Set<String>> e_d_entry : AETToDSs.entrySet()){
                ...
                Log.logData(processing_method_structInfo, Utils.generatePartingLine("="));
                Log.logData(processing_method_structInfo, "+ Associated element type: " + associated_element_type);
                for(String ds : data_structures) {
                    Log.logData(processing_method_structInfo, Utils.generatePartingLine("-"));
                    Log.logData(processing_method_structInfo, "-- Data structure: " + ds);
                }

...
public class Utils {
    ...
    public static String getMethodNameFromMethodSig(String method_sig){
        if(method_sig == null) return null;
        String method_subsig = method_sig.split(" ")[2];
        String method_name = method_subsig.substring(0, method_subsig.indexOf("("));
        return method_name;
    }
